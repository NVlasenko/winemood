...
import { WINE_TYPE_BY_CATEGORY } from "@/components/home/PopularCategories/config/categoryMappings";
...
const normalizeCategoryType = (type: string) => type.trim().toLowerCase();
...
const getWineTypeByCategory = (type: string) => {
  ...
  return isCategoryTypeKey(normalized) ? WINE_TYPE_BY_CATEGORY[normalized] : "";
};

export const ProfileCategories = ({ categories }: ProfileCategoriesProps) => {
      ...
      <div className="container">
        ...
        <div className="profile-categories__grid">
          {categories.map((category) => (
            <div key={category.id} className="profile-categories__card">
              <img
              ...
              <div className="profile-categories__title-wrapper">
                <h3 className="profile-categories__title">{category.title}</h3>
              </div>
