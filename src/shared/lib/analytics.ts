...
export const analytics = {
  searchStarted: (query: string, searchType: "catalog" = "catalog") => {
  ...
  pageViewed: (pageUrl: string, eventId: string) => {
    return sendAnalyticsEvent({
      eventId,
  ...
  sessionStarted: (sessionId: string, deviceType: AnalyticsDeviceType) => {
    return sendAnalyticsEvent({
      eventId: createAnalyticsEventId(),
