...
export const AuthProvider = ({ children }: Props) => {
  ...
  const [isAuthReady, setIsAuthReady] = useState(() => !getSavedAccessToken());
  ...
  }, [accessToken, updateUser, invalidateSession]);

  const syncSavedQuiz = useCallback(
  ...
  const login = useCallback(
    ...
    [saveAuthData, updateUser, syncSavedQuiz, invalidateSession]
  );
  ...
  const value = useMemo(
    () => ({
      ...
      isAuthenticated: isAuthReady && Boolean(accessToken && user),
